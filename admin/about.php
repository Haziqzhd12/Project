		...
		<div class="row">
			<div class="col-md-3 col-xl-3">
				<div class="card" >
					...
					<div class="list-group list-group-flush" role="tablist" style="border-bottom-right-radius: 1rem; border-bottom-left-radius: 1rem;">
									...
									<div class="row">
										<div class="col-md-12">
											...
											<div class="mb-3">
												...
												<textarea class="form-control" id="inputdescription" name="about_desc" rows="2" placeholder="Enter Your Description"><?php echo htmlspecialchars($edit_about_desc); ?></textarea>
											</div>
										</div>
										<div class="col-6">
											<div class="mb-3">
										...
										<form action="" method="POST" enctype="multipart/form-data">
											<div class="d-flex justify-content-center align-items-center mt-4">
												<div class="btn btn-success position-relative">
													Choose Image
													<input type="file" class="file-upload position-absolute top-0 start-0 w-100 h-100 opacity-0" value="Upload" name="about_file" onchange="previewFile(this);" accept="image/*">
												</div>
												<input type="submit" name="photo" class="btn btn-primary ms-3" value="Save Changes">
											</div>
										</form>
									</div>
								</div>
