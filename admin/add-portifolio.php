...
<main class="content">
	<div class="container-fluid p-0">
		<h1 class="h3 mb-3"><strong>Add</strong> Portofolio</h1>
		<form action="" method="POST" enctype="multipart/form-data">
			<div class="row">
			<div class="col-12 col-lg-4 d-flex">
					<div class="card">
						<div class="card-header" style="border-radius:1rem;">
							<h5 class="card-title mb-0">Portofolio Image</h5>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="mb-3">
										...
										<textarea type="text" rows="2" class="form-control" id="portifolio_desc"
