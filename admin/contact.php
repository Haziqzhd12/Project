							...
							<div class="card-body">
								<form action="" method="POST">
									<div class="row">
										<div class="col-md-12">
											<div class="mb-3">
												<label class="form-label" for="inputcontactinfo">Contact Description</label>
												<textarea rows="4" class="form-control" id="inputcontactinfo" name="contact_info" placeholder="Enter Contact Info"><?php echo clean($edit_contact_info); ?> </textarea>
											</div>
											<div class="mb-3">
								...
								<form action="" method="POST">
									<div class="row">
										<div class="col-6">
											...
											<div class="mb-3">
												<label class="form-label" for="contact_tw">Github Username</label>
										...
										<div class="col-6">
											...
											<div class="mb-3">
												<label class="form-label" for="contact_wts">Whatsapp Number</label>
