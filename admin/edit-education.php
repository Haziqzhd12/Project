							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="mb-3">
										...
										<textarea class="form-control" id="education_desc" name="education_desc" rows="2" placeholder="Enter Education Description"><?php echo htmlspecialchars($edit_education_desc); ?></textarea>
									</div>
									<div class="mb-3">
