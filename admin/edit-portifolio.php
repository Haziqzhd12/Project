...
<main class="content">
	<div class="container-fluid p-0">
		<h1 class="h3 mb-3"><strong>Edit</strong> Portofolio</h1>
				...
				<div class="col-12 col-lg-3 d-flex">
					<div class="card">
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
									<h5 class="card-title mb-0">Portofolio Image</h5><br>
				...
				<div class="col-12 col-lg-9 d-flex">
					<div class="card">
						<div class="card-header" style="border-radius:1rem";>
							<h5 class="card-title mb-0">Portofolio info</h5>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
									<div class="mb-3">
                                    <label class="form-label" for="inputTitle">Portofolio Title</label>
									...
									<div class="mb-3">
                                    <label class="form-label" for="portifolio_desc">Portofolio Description</label>
									<textarea rows="2" class="form-control" id="portifolio_desc" name="portifolio_desc" placeholder="Enter Portfolio Description"><?php echo htmlspecialchars($edit_portifolio_desc); ?></textarea>
									...
									<div class="mt-4">
										<h5 class="card-title mb-0">Portofolio Status</h5><br>
...
<script>
	function previewFile(input) {
		...
		reader.onload = function(e) {
			document.getElementById('portifolioImg').src = e.target.result;
		}
