		...
		<div class="row">
			<div class="col-md-3 col-xl-3">
				<div class="card">
					...
					<div class="list-group list-group-flush" role="tablist" style="border-bottom-left-radius:1rem; border-bottom-right-radius:1rem;">
											...
											<div class="d-flex justify-content-center align-items-center mt-4">
												<div class="me-2">
													<label class="btn btn-success">
														Choose Logo
														<input type="file" class="file-upload" name="logo_file" onchange="previewFile(this);" accept="image/*" style="display: none;">
													</label>
												</div>
												<input type="submit" name="logo" class="btn btn-primary" value="Save Changes">
											</div>
										</form>
									</div>
								</div>
