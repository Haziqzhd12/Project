<nav id="sidebar" class="sidebar js-sidebar">
	<div class="sidebar-content js-simplebar">
		...
		<ul class="sidebar-nav">
			...
			<li class="sidebar-item <?php if($page=="portfolio.php"){echo "active";} ?>">
			...
			<li class="sidebar-item <?php if($page=="blog.php"){echo "active";} ?>">
				<a class="sidebar-link" href="blog.php">
					<i class="align-middle" data-feather="book"></i> <span class="align-middle">MyBlog</span>
				</a>
			</li>

			<li class="sidebar-item <?php if($page=="skill.php"){echo "active";} ?>">
				<a class="sidebar-link" href="skill.php">
					<i class="align-middle" data-feather="slack"></i> <span class="align-middle">MySkill</span>
				</a>
			</li>
